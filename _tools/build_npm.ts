...
await build({
  ...
  package: {
    name: "@coinset/bitmart",
    version: Deno.args[0]?.replace(/^v/, ""),
    description: "Universal BitMart API client",
    license: "MIT",
    sideEffects: false,
    "publishConfig": {
      "access": "public",
    ...
    repository: {
      type: "git",
      url: "https://github.com/coinset/bitmart.git",
    },
    bugs: {
      url: "https://github.com/coinset/bitmart/issues",
    },
    homepage: "https://github.com/coinset/bitmart#readme",
    funding: {
      type: "patreon",
